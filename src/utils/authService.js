...
const authService = {
  ...
  async signInWithOTP(email) {
    try {
      ...
      return { success: false, error: 'Something went wrong sending OTP. Please try again.' };
    }
  },
  ...
  async verifyOTP(email, token) {
    try {
      ...
      return { success: false, error: 'Something went wrong verifying OTP. Please try again.' };
    }
  },
